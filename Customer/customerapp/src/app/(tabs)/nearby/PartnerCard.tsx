...
interface PartnerCardProps {
  ...
  /** Minutes remaining on a paid call — shows a countdown chip when set */
  callMinutesLeft?: number | null;
}
    ...
    >
      <Animated.View style={[styles.card, isBooked && styles.cardBooked, isBooked && { paddingTop: spacing.md + 22 }, { transform: [{ scale }] }]}>
        ...
        <View style={styles.body}>
          ...
          {/* ── Call minutes remaining chip ── */}
          {callMinutesLeft != null && callMinutesLeft > 0 && (
            <View style={styles.callMinutesRow}>
              <Ionicons name="time" size={12} color="#1E40AF" />
              <Text style={styles.callMinutesText}>
                Call · {callMinutesLeft} min left
              </Text>
            </View>
          )}
        </View>
