...
const styles = StyleSheet.create({
  ...
  heroTitle: {
    ...
    color: colors.white, lineHeight: 38, letterSpacing: 0.1,
  },
  heroSub: {
  ...
  cardTitle: { fontSize: 22, fontWeight: "700", color: "#6B7280", marginBottom: spacing.xs },
  cardSubtitle: { fontSize: 14, lineHeight: 20, color: "#9CA3AF", marginBottom: spacing.md + spacing.sm },
  ...
  digitBox: {
    width: 46, height: 56, borderRadius: radii.sm + 2,
  ...
  digitBoxFilled: { backgroundColor: "#FFFFFF", borderColor: colors.primary },
  digitText: { fontSize: 22, fontWeight: "700", color: "#000000" },

  hiddenInput: {
    position: "absolute", left: -500, top: 0,
